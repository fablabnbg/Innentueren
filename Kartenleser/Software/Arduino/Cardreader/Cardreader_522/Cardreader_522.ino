...
volatile uint8_t command[256]   = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                    ...
                                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
                                    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
volatile uint8_t wcommand       =   0;          // Writeindex for command array. Automaticaly wraps at array end.
volatile uint8_t rcommand       =   0;          // Readindex for command array. Automaticaly wraps at array end.
...
void loop() {
    ...
    if (! Player.isPlaying()){         // We dont play a tone
      if (rcommand != wcommand ){              // And we have something to Play
